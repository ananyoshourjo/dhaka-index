...
import { JOB_FUNCTIONS } from "../../../src/lib/job-functions";
    ...
    <div className="bg-background py-2" role="search">
      ...
      >
        ...
        <div className="col-span-2 col-start-1 row-start-2 sm:col-span-1 sm:col-start-2 sm:row-start-1">
          <span id="admin-job-function-filter-label" className="sr-only">
          ...
          >
            <SelectTrigger
              aria-labelledby="admin-job-function-filter-label"
