...
export default async function SetupPage() {
  ...
  if (!isFirstRegisteredUser(user.id)) {
    return (
      <main className="mx-auto grid min-h-[calc(100vh-61px)] w-full max-w-lg place-items-center px-4">
        <section className="w-full rounded-2xl border bg-card p-7 text-card-foreground">
  ...
  return (
    <main className="mx-auto grid min-h-[calc(100vh-61px)] w-full max-w-lg place-items-center px-4 py-10">
      <section className="w-full overflow-hidden rounded-2xl border bg-card text-card-foreground">
        <div className="border-b bg-foreground px-7 py-6 text-background">
